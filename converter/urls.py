...
urlpatterns = [
    ...
    path('ai-label/', views.upload_ai_label, name='upload_ai_label'),
    path('ai-label-progress/<str:task_id>/', views.check_ai_label_progress, name='check_ai_label_progress'),
    path('ai-label-download/<str:task_id>/', views.download_ai_label_file, name='download_ai_label_file'),
